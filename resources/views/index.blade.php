            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="/home"><img src="{{asset ('style/assets/images/logo/btn.png') }}"></a>
                        </div>
                        <div class="toggler">
                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">Server</h6>
                                            ...
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    <svg class="bi text-primary" width="32" height="32" fill="blue"
                                                        style="width:10px">
                                                        <use
                                                            xlink:href="{{asset ('style/assets/vendors/bootstrap-icons/bootstrap-icons.svg#circle-fill') }}" />
                                                    </svg>
                                                    <h5 class="mb-0 ms-3">DC Sentul</h5>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h5 class="mb-0 ms-3">OC Jakarta</h5>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h5 class="mb-0 ms-3">DC Surabaya</h5>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="{{asset ('style/assets/images/faces/5.jpg') }}">
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="{{asset ('style/assets/images/faces/2.jpg') }}">
                                                                </div>
                            ...
                            <div class="card-body py-4 px-5">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-xl">
                                        <img src="{{asset ('style/assets/images/faces/1.jpg') }}" alt="Face 1">
                                    </div>
                                    <div class="ms-3 name">
                            ...
                            <div class="card-content pb-4">
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="{{asset ('style/assets/images/faces/4.jpg') }}">
                                    </div>
                                    <div class="name ms-4">
                                ...
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="{{asset ('style/assets/images/faces/1.jpg') }}">
                                    </div>
                                    <div class="name ms-4">
